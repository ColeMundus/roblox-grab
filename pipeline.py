...
LUA_SHA1 = get_hash(os.path.join(CWD, 'roblox.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", "roblox-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("roblox-item: %(item_name)s"),
        ]
...
project = Project(
    title = "roblox",
    project_html = """
    <img class="project-logo" alt="logo" src="http://archiveteam.org/images/2/22/Roblox_logo_2017.png" />
    <h2>forum.roblox.com <span class="links"><a href="https://forum.roblox.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/roblox/">Leaderboard</a></span></h2>
    """,
    utc_deadline = datetime.datetime(2017, 7, 27, 23, 59, 0)
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="roblox"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
    ...
    MoveFiles(),
    LimitConcurrent(NumberConfigValue(min=1, max=500, default="20",
